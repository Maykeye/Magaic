...
local function setup()
    ...
    vim.keymap.set("n", "<leader>mc", magaic.display_buffer, {desc = "Chat"})
    vim.keymap.set("n", "<leader>mr", magaic.display_buffer, {desc = "Raw completition"})
    vim.keymap.set("n", "<leader>mm", magaic.display_buffer, {desc = "Look/change model"})
